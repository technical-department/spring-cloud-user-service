...
@TableName("t_grassroot_legal_service")
public class GrassrootLegalService implements Serializable {
     ...
     * 自增id
     */
    @TableId(value = "grassroot_legal_service_id", type = IdType.AUTO)
