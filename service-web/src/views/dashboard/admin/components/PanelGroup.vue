    ...
    <el-col :xs="24" :sm="24" :lg="12" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="allUserNum" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="24" :sm="24" :lg="12" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="downloadNum" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="24" :sm="24" :lg="12" class="card-panel-col">
...
import { getStatistics } from '@/api/banner'
  ...
  methods: {
    init() {
      getStatistics().then(res => {
        ...
        this.downloadNum = res.data.downloadNum
      })
    }
  }
}
