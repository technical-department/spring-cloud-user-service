<template>
  <div>
    ...
    <div class="" style="margin: 10px auto; width: 98%;">
      <el-table :data="list" :page="page" @search-change="searchChange"
                @on-load="getList" @refresh-change="getList"
                row-key="id"
                border >
        <el-table-column
          prop="title"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button size="small" type="text" icon="el-icon-edit" @click="handleAdd(scope.row)">添加</el-button>
    ...
    methods: {
      ...
      confimAdd() {
        ...
        if (this.id) {
          ...
          addObj(this.title, this.content, files, this.code).then(res => {
            this.$notify({
              title: '成功',
              message: '添加成功',
              type: 'success',
