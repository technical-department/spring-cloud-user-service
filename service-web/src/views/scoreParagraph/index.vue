...
<script>
import { tableOption } from '../../const/crud/scoreParagraph/scoreParagraph'
import { queryList, delById, addObj, checkPrecent } from '@/api/scoreParagraph'
export default {
  name: 'AppVersion',
  data() {
    return {
  ...
  methods: {
    ...
    confimAdd() {
      ...
      addObj(this.form.year, this.form.proviceId, this.form.isArts, this.uplodeUrl).then(res => {
